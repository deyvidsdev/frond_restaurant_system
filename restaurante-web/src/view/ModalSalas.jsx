    ...
    <div className="modal flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-700 bg-opacity-50 dark:bg-negro-claro dark:bg-opacity-50">
        <div className="modal-content bg-white rounded shadow-lg p-6 max-w-sm mx-auto">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="number" name="Mesa" value={form.Mesa || ''} onChange={handleChange} placeholder="Mesa" className="mb-2 p-2 w-full border rounded dark:text-negro-claro" />
                <textarea name="Descripcion" value={form.Descripcion} onChange={handleChange} placeholder="Descripción" className="mb-2 p-2 w-full border rounded dark:text-negro-claro" />
