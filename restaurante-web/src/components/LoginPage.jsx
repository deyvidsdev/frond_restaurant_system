        ...
        <div className={`${theme} `}>
            ...
            <div className={`flex h-screen justify-center items-center dark:bg-gray-800`} >
                <div className="w-96 h-96 bg-white dark:bg-gray-900 rounded-lg shadow-lg flex flex-col items-center justify-center p-4">
                    ...
                    <form className="w-full mt-10" onSubmit={handleClick}>
                        ...
                        <button  type="submit" className="w-full mt-10 bg-blue-900 dark:bg-gray-400 dark:font-semibold text-white py-2 rounded-md hover:bg-blue-800">
                            Iniciar Sesión
                        </button>
                    </form>
                </div>
