...
export default function PisosDisponiblesVentas({text, active, handleContentClick}) {
    ...
    return(
        <>
            <div className="flex flex-col w-52 h-56 items-center justify-center shadow-xl dark:bg-gradient-to-b from-gris-top-dashboard to-gris-bottom-dashboard rounded-xl cursor-pointer" onClick={handleClick}>
